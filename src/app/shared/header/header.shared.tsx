...
import { selectCurrentMode } from "@/app/state-manager/selectors";
...
export const HeaderSharedComponent = () => {
   ...
   * event handlers
   */
  const onModeChange = (newMode: IAppThemeMode) => {
  ...
  return (
    <div className={`header poppins-regular ${mode}`}>
      <div className={`header__links ${mode}`}>
        <Link
          href="/home"
      ...
      <div className={`header__theme-switcher ${mode}`}>
        <div
